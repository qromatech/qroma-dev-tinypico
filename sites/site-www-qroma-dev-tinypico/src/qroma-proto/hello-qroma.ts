...
/**
 * @generated from protobuf message QromaHeartbeatUpdate
 */
export interface QromaHeartbeatUpdate {
    /**
     * @generated from protobuf field: string heartbeatMessage = 1;
     */
...
class QromaHeartbeatUpdate$Type extends MessageType<QromaHeartbeatUpdate> {
    constructor() {
        super("QromaHeartbeatUpdate", [
            { no: 1, name: "heartbeatMessage", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "uptime", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    create(value?: PartialMessage<QromaHeartbeatUpdate>): QromaHeartbeatUpdate {
        const message = { heartbeatMessage: "", uptime: 0 };
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<QromaHeartbeatUpdate>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: QromaHeartbeatUpdate): QromaHeartbeatUpdate {
        let message = target ?? this.create(), end = reader.pos + length;
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* string heartbeatMessage */ 1:
                    message.heartbeatMessage = reader.string();
                    break;
    ...
    internalBinaryWrite(message: QromaHeartbeatUpdate, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* string heartbeatMessage = 1; */
        if (message.heartbeatMessage !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.heartbeatMessage);
        /* uint32 uptime = 2; */
        if (message.uptime !== 0)
...
/**
 * @generated MessageType for protobuf message QromaHeartbeatUpdate
 */
export const QromaHeartbeatUpdate = new QromaHeartbeatUpdate$Type();
// @generated message type with reflection information, may provide speed optimized methods
